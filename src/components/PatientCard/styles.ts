...
export const Container = styled.div`
  ...
  box-shadow: 0px 0px 4px 0px ${({ theme }) => theme.colors.blue.light};
...
export const PatitentSubtitle = styled.p`
  font-size: 1.4rem;
  font-weight: 400;
  color: ${({ theme }) => theme.colors.blue.anotherVariation};
  margin-bottom: 0.8rem;
`;
...
export const PatientCategory = styled.div`
  ...
  width: 10rem;
  padding: 0.25rem 0;
  background-color: ${({ theme }) => theme.colors.blue.secondVariation};
  border-radius: 5px;
  font-weight: 500;
  font-size: 1.4rem;
